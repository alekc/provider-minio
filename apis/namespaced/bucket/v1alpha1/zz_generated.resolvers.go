...
// ResolveReferences of this Retention.
func (mg *Retention) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this ServerSideEncryption.
func (mg *ServerSideEncryption) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this Versioning.
func (mg *Versioning) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)

...
type GroupPolicyAttachmentInitParameters struct {
	...
	// (String) Name of group to attach policy to
	// Name of group to attach policy to
	// +crossplane:generate:reference:type=github.com/alekc/provider-minio/apis/namespaced/iam/v1alpha1.Group
	GroupName *string `json:"groupName,omitempty" tf:"group_name,omitempty"`

	// Reference to a Group in iam to populate groupName.
	// +kubebuilder:validation:Optional
	GroupNameRef *v1.NamespacedReference `json:"groupNameRef,omitempty" tf:"-"`

	// Selector for a Group in iam to populate groupName.
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/alekc/provider-minio/apis/namespaced/iam/v1alpha1.Policy
